...
# Masukkan nilai suhu, kelembaban, dan pH tanah
suhu_input = float(input("Masukkan nilai suhu (20-40): "))
kelembaban_input = float(input("Masukkan nilai kelembaban (40-100): "))
ph_tanah_input = float(input("Masukkan nilai pH tanah (4-8): "))
...
print("Tingkat Penyakit Blast pada Padi: ", diagnosis)